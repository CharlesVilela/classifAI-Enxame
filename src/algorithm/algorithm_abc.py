...
# ============================================================
# 🔹 Função genérica de otimização ABC com Mealpy
# ============================================================
def abc_optimize(model_objective, var_types, lb, ub, n_bees=20, iters=50):
    bounds = []
    ...
    model = ABC.OriginalABC(epoch=iters, pop_size=n_bees)
...
def objective_rf_cv(solution, X_train, y_train):
    ...
    # Corrigir max_depth para None se <=0, senão garantir >=1
...
# ============================================================
# 🔹 Pipeline principal integrado com ABC
# ============================================================
def build_pipeline_complete_abc(x, y):
    ...
    # train_and_evaluate(lr_model, "Logistic Regression (ABC)", X_train, X_test, y_train, y_test)
    ...
    train_and_evaluate(rf_model, "Random Forest (ABC)", X_train, X_test, y_train, y_test)

# ============================================================
# 🔹 Exemplo de uso
# ============================================================
# df = pd.read_csv("seus_dados.csv")
# build_pipeline_complete_abc(df["text"], df["label"])
